...
import { PlatoonTable, PlatoonRow } from '@/components/stuff/PlatoonTable'
import { PitcherFilter } from '@/components/stuff/PitcherFilter'
import { Pitcher } from '@/lib/stuff/types'
...
function PlatoonContent() {
  ...
  useEffect(() => {
    ...
    router.replace(qs ? `/stuff/platoon?${qs}` : '/stuff/platoon', { scroll: false })
